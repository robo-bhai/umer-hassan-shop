...
# ==========================================
# ENGINE START WITH PROGRESS BAR + AUTO CHROME (FIXED)
# ==========================================
start_engine_progress() {
    clear
    echo ""
    echo "   ╔══════════════════════════════════════╗"
    ...
    # ✅ OPEN CHROME (Server ready hai ab)
    open_chrome
...
if [ "$USER_KEY" = "UKBH" ]; then
    ...
    if [ -d "$HIDDEN_DIR" ]; then
        # Start engine with progress bar + auto chrome
        start_engine_progress
    fi
fi